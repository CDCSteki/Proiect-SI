...
export const routes: Routes = [
  ...
  { path: 'register', loadComponent: () => import('./features/auth/register/register').then(m => m.Register) },
  {
    ...
    loadComponent: () => import('./features/dashboard/client-dashboard/client-dashboard').then(m => m.ClientDashboard)
  },
  {
    path: 'manager',
    canActivate: [authGuard],
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () => import('./features/appointments/appointment-new/appointment-new').then(m => m.AppointmentNew)
  },
  {
    path: 'cars',
    canActivate: [authGuard],
